...
def run_command_in_services(root, cmd):
    ...
    for dir in os.listdir(root):
        ...
        try:
            ...
            print(f"Error on command running, Command : '{cmd}', Service Folder : '{service_directory}'")
...
if __name__ == "__main__":
    ...
    parser.add_argument('root', nargs='?', default='.', help="Root directory to search (default: current directory).")
    parser.add_argument('--cmd', default="make", help="Command to run in all services folder")
